 ...
 * 
 * Provide private keys and certificates during the TLS handshake using the
 * Android 4.0 KeyChain API. If interactive selection is requested, we harvest
 * the parameters during the handshake and abort with a custom (runtime)
 * ClientCertificateAliasRequiredException.
 * 
...
public class KeyChainKeyManager extends X509ExtendedKeyManager {
    ...
    public String chooseClientAlias(String[] keyTypes, Principal[] issuers, Socket socket) {
        ...
        if (K9.DEBUG)
            Log.d(K9.LOG_TAG, "KeyChainKeyManager.chooseClientAlias returning preselected alias " + mAlias);
    ...
    public PrivateKey getPrivateKey(String alias) {
        try {
             ...
             * 4.2 with "Fatal signal 11 code=1".
             * 
    ...
    public static boolean areAnyCerts() {
        try
        {
            ...
            Log.e(K9.LOG_TAG, "KeyChainKeyManager.areAnyCerts", e);
            return false;
